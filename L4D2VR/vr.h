...
public:
	...
	vr::VROverlayHandle_t m_DashboardHandle = vr::k_ulOverlayHandleInvalid;
	vr::VROverlayHandle_t m_LoadingScreenHandle = vr::k_ulOverlayHandleInvalid;
	...
	Vector GetLeftControllerAbsPos(Vector eyePosition = {0, 0, 0});
