...
typedef int(__thiscall* tEntindex)(void* thisptr);
	...
	typedef void(__cdecl* tS_UpdateListener)(const Vector& origin, const Vector& forward, const Vector& right, const Vector& up);
	typedef void(__thiscall* tEmitSound)(void* thisptr, void* filter, int iEntIndex, int iChannel, const char* pSoundEntry, unsigned int nSoundEntryHash, const char* pSample, float flVolume, float flAttenuation, int nSeed, int iFlags, int iPitch, const Vector* pOrigin, const Vector* pDirection, void* pUtlVecOrigins, bool bUpdatePositions, float soundTime, int nSpeakerEntity, int nStartDelay);
...
public:
	...
	static inline Hook<tS_UpdateListener> hkS_UpdateListener;
	static inline Hook<tEmitSound> hkEmitSound;
	...
	static void __cdecl dS_UpdateListener(const Vector& origin, const Vector& forward, const Vector& right, const Vector& up);
	static void __fastcall dEmitSound(void* ecx, void* edx, void* filter, int iEntIndex, int iChannel, const char* pSoundEntry, unsigned int nSoundEntryHash, const char* pSample, float flVolume, float flAttenuation, int nSeed, int iFlags, int iPitch, const Vector* pOrigin, const Vector* pDirection, void* pUtlVecOrigins, bool bUpdatePositions, float soundTime, int nSpeakerEntity, int nStartDelay);
